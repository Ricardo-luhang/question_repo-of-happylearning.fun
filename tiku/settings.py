"""
Django settings for tiku project.
...
SECRET_KEY = 'aam56_xat)^%@0cl&!c9+(3e4_@31#9h*7m2hn=ws$-om7d-(u'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tiku.request_content.global_data',
            ],
        },
    },
]

WSGI_APPLICATION = 'tiku.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://192.168.0.39:6379',
        "OPTIONS": {
...
LOGGING = {
    ...
    'handlers': {
        ...
        'captcha_handler': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(LOG_ROOT, 'captcha.log'),
            'maxBytes': 1024 * 1024 * 5,
            'backupCount': 5,
            'formatter': 'standard',
        },
    ...
    'loggers': {
        ...
        'captcha': {
            'handlers': ['captcha_handler', 'console'],
            'level': 'DEBUG',
            'propagate': False
        },
    }
